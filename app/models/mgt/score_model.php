<?php
//成绩管理
class score_model extends BaseModel {
	...
	public function insert($data) {
		...
		$sql = "INSERT INTO lesson_score ($p1) VALUES ($p2)";
	...
	function update($data) {
		...
		$sql = "update lesson_score set $p1 where id=?";
		$result = $this->excuteSQL($sql,$params) ;
	...
	public function query($data=array()) {
		...
		$sql = "select * from lesson_score where 1=1 $p1 order by id ";
